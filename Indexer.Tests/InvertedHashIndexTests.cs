...
{
    [TestFixture]
    public class InvertedHashIndexTests
    {
        [Test]
        public void Can_Add_To_Index_And_Find_Matches()
        {
            ...
            var invertedIndex = new InvertedHashIndex(new CodeTokenizer());
        ...
        private static void InsertPhraseToIndex(InvertedHashIndex index, string phrase, string pathHash = null)
        {
